...
| create_composite_rule        | O(n)              | O(n)               |       30.63 |               51   |                   0 |
| create_pattern_rule          | O(n)              | O(n)               |       48.05 |               80.1 |                   4 |
| create_bounded_sequence_rule | O(1)              | O(1)               |       30.54 |               50.9 |                   0 |
| create_alternation_rule      | O(n)              | O(1)               |       19.32 |               32.2 |                   2 |
| create_balanced_rule         | O(n²)             | O(n)               |       24.25 |               40.4 |                   1 |
| create_numerical_range_rule  | O(n)              | O(1)               |       22.25 |               37.1 |                   1 |
| create_property_match_rule   | O(n)              | O(1)               |       39.4  |               65.7 |                   3 |
| create_group_rule            | O(n)              | O(1)               |       46    |               76.7 |                   0 |
| create_meta_rule             | O(n)              | O(1)               |       45.55 |               75.9 |                   0 |
...
Traceback (most recent call last):
  File "/Users/jneumann/Repos/seqrule/src/seqrule/analysis/analyzer.py", line 499, in analyze
...
Traceback (most recent call last):
  File "/Users/jneumann/Repos/seqrule/scripts/analyze_rules.py", line 482, in analyze_rule_generator
    analysis = analyzer.analyze(example_rule)
  File "/Users/jneumann/Repos/seqrule/src/seqrule/analysis/analyzer.py", line 608, in analyze
...
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.005 |     0.002 |               0.09 |                0 |
|               1 |           0.005 |     0.001 |               0    |                0 |
|              10 |           0.014 |     0.006 |               0    |                0 |
|             100 |           0.058 |     0.028 |               0    |                0 |
|            1000 |           0.884 |     0.584 |               0.01 |                0 |
...
|              10 |           0.015 |     0.009 |               0    |                0 |
|             100 |           0.014 |     0.004 |               0    |                3 |
|            1000 |           0.013 |     0.005 |               0.01 |                0 |



Size-Time Correlation: -0.176
...
|   Sequence Size |   Avg Time (ms) |   Std Dev |   Peak Memory (MB) |   GC Collections |
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.003 |     0.001 |               0.01 |              331 |
|               1 |           0.016 |     0.008 |               0.01 |                0 |
|              10 |           0.021 |     0.01  |               0.03 |                0 |
|             100 |           0.041 |     0.008 |               0    |                0 |
|            1000 |           0.215 |     0.022 |               0    |                0 |
...
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.004 |     0.002 |               0    |               36 |
|               1 |           0.012 |     0.004 |               0.13 |                0 |
|              10 |           0.011 |     0.003 |               0    |                9 |
|             100 |           0.005 |     0.003 |               0    |                0 |
|            1000 |           0.005 |     0.002 |               0.01 |                0 |



Size-Time Correlation: -0.384
...
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.004 |     0.001 |               0    |                0 |
|               1 |           0.013 |     0.005 |               0.15 |                0 |
|              10 |           0.028 |     0.012 |               0    |                0 |
|             100 |           0.121 |     0.056 |               0    |                0 |
|            1000 |           1.114 |     0.557 |               0    |                0 |
...
|   Sequence Size |   Avg Time (ms) |   Std Dev |   Peak Memory (MB) |   GC Collections |
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.003 |     0.001 |               0.02 |                0 |
|               1 |           0.007 |     0.003 |               0.04 |                0 |
|              10 |           0.006 |     0.002 |               0    |                0 |
|             100 |           0.008 |     0.003 |               0    |                0 |
|            1000 |           0.01  |     0.003 |               0    |                0 |
...
|               0 |           0.006 |     0.003 |               0    |                0 |
|               1 |           0.011 |     0.002 |               0    |                3 |
|              10 |           0.007 |     0.002 |               0.04 |                0 |
|             100 |           0.012 |     0.003 |               0    |                0 |
|            1000 |           0.012 |     0.004 |               0.03 |                0 |



Size-Time Correlation: 0.553
...
|               1 |           0.003 |     0.001 |               0    |                0 |
|              10 |           0.01  |     0.004 |               0    |                0 |
|             100 |           0.049 |     0.027 |               0.01 |                6 |
|            1000 |           0.687 |     0.612 |               0    |                0 |
...
|              10 |           0.017 |     0.007 |               0    |               12 |
|             100 |           0.017 |     0.008 |               0    |                0 |
|            1000 |           0.015 |     0.005 |               0.05 |                0 |



Size-Time Correlation: 0.353
...
|               0 |           0.003 |     0.001 |               0    |                0 |
|               1 |           0.011 |     0.005 |               0    |                0 |
|              10 |           0.014 |     0.005 |               0.01 |                0 |
|             100 |           0.048 |     0.005 |               0.01 |                0 |
|            1000 |           0.282 |     0.018 |               0.05 |                9 |
...
|               1 |           0.014 |     0.004 |               0    |                0 |
|              10 |           0.024 |     0.006 |               0    |                6 |
|             100 |           0.062 |     0.009 |               0    |               11 |
|            1000 |           0.422 |     0.019 |               0.01 |                0 |
...
|----------------:|----------------:|----------:|-------------------:|-----------------:|
|               0 |           0.004 |     0.001 |               0    |                0 |
|               1 |           0.006 |     0.002 |               0.05 |                0 |
|              10 |           0.01  |     0.003 |               0    |                7 |
|             100 |           0.03  |     0.001 |               0.01 |                8 |
|            1000 |           0.258 |     0.022 |               0    |                0 |
...
|               0 |           0.004 |     0.002 |               0    |                0 |
|               1 |           0.015 |     0.005 |               0    |                0 |
|              10 |           0.017 |     0.006 |               0.01 |                0 |
|             100 |           0.106 |     0.011 |               0    |               12 |
|            1000 |          30.997 |    18.445 |               0.02 |                9 |
